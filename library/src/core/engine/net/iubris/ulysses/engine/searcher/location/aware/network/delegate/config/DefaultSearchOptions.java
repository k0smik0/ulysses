 ...
 ******************************************************************************/
package net.iubris.ulysses.engine.searcher.location.aware.network.delegate.config;
...
public class DefaultSearchOptions implements SearchOptions {
	...
	protected static final int DEFAULT_RADIUS = 5000; // meters
	protected final HashSet<GooglePlaceType> types;
	
	public DefaultSearchOptions() {
//		System.out.println("ConfigOptionalImpl: "+this.hashCode());
		types = new HashSet<GooglePlaceType>();
	}

	/**
	 * @return an empty HashSet, to populate implementing abstract addTypes() method
	 */
	@Override
