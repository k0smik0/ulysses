...
public class UlyssesLocalizedSearcherNetworkAware extends AbstractLocalizedSearcherNetworkAwareStrictChecking<List<PlaceEnhanced>> {

	private final SocratesDelegate socratesDelegate;
	private List<PlaceEnhanced> result;
	...
	public UlyssesLocalizedSearcherNetworkAware(CheckerStateNetworkAware checkerStateNetworkAware,SocratesDelegate socratesDelegate) {
		...
		result = new ArrayList<PlaceEnhanced>(0); // NullObject Pattern
