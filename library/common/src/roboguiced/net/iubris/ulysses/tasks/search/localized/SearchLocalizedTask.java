 ...
 */
public class SearchLocalizedTask extends RoboSearchLocalizedAsyncTask<UlyssesSearcher,Void,Void,List<PlaceEnhanced>> {
...
//	}
	 ...
	 */
	@Override
	public List<PlaceEnhanced> call() throws AddressNullException, NoNetworkException, NetworkAwareSearchException, IOException {
		if (address==null)
	...
	/**
	 * default: calls {@link UlyssesLocalizedSearcher#search(locations)} to retrieve results
	 * @param {@link Location}
	 * @return {@link PlaceEnhanced}
	 * @throws NetworkAwareSearchException 
	 * @throws NoNetworkException 
	 */
	protected List<PlaceEnhanced> callLocalizedSearcher(Location[] locations) throws NoNetworkException, NetworkAwareSearchException {
